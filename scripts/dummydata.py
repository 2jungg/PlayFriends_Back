...
def get_dummy_activities(category_ids):
    ...
    activities.extend([
        ...
        ActivityModel(name="태평소국밥", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.3957, 36.3365]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.KOREAN], ingredients=[FoodIngredient.MEAT], tastes=[FoodTaste.SALTY], cooking_methods=[FoodCookingMethod.SOUP])),
        ...
        ActivityModel(name="전미원", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.340, 36.318]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.KOREAN], ingredients=[FoodIngredient.MEAT], tastes=[], cooking_methods=[FoodCookingMethod.GRILL])),

        # --- 양식, 중식, 일식, 기타 ---
        ActivityModel(name="컬리나리아", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.350, 36.360]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.FLOUR, FoodIngredient.FISH], tastes=[], cooking_methods=[FoodCookingMethod.STIR_FRIED])),
        ...
        ActivityModel(name="치앙마이방콕", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.433, 36.331]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.SOUTEAST_ASIAN], ingredients=[FoodIngredient.FLOUR, FoodIngredient.FISH], tastes=[FoodTaste.SOUR, FoodTaste.SWEET], cooking_methods=[FoodCookingMethod.STIR_FRIED])),
        ...
        ActivityModel(name="라쿠시나에비노", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.378, 36.355]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.MILK, FoodIngredient.FLOUR], tastes=[], cooking_methods=[FoodCookingMethod.STIR_FRIED])),
    ...
    activities.extend([
        ...
        ActivityModel(name="소나무집", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.443, 36.361]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.KOREAN], ingredients=[FoodIngredient.FLOUR], tastes=[FoodTaste.SPICY], cooking_methods=[FoodCookingMethod.SOUP])),
        ...
        ActivityModel(name="바다황제", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.375, 36.358]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.KOREAN], ingredients=[FoodIngredient.FISH], tastes=[FoodTaste.SPICY], cooking_methods=[FoodCookingMethod.SOUP])),

        # --- 양식, 중식, 일식, 기타 ---
        ActivityModel(name="맨오브워", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.359, 36.362]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.MEAT], tastes=[], cooking_methods=[FoodCookingMethod.GRILL])),
        ActivityModel(name="잇마이타이", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.348, 36.363]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.SOUTEAST_ASIAN], ingredients=[FoodIngredient.FISH, FoodIngredient.FLOUR], tastes=[FoodTaste.SPICY, FoodTaste.SOUR], cooking_methods=[FoodCookingMethod.STIR_FRIED])),
    ...
    activities.extend([
        ...
        ActivityModel(name="인터뷰맨션", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.345, 36.366]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.MEAT, FoodIngredient.MILK], tastes=[], cooking_methods=[])),
        ...
        ActivityModel(name="홀리데이", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.384, 36.351]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.FLOUR], tastes=[FoodTaste.SOUR], cooking_methods=[FoodCookingMethod.STIR_FRIED])),
        ActivityModel(name="피제리아616", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.349, 36.360]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.WESTERN], ingredients=[FoodIngredient.MILK, FoodIngredient.FLOUR], tastes=[FoodTaste.SALTY], cooking_methods=[])),
        ...
        ActivityModel(name="카라마데", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.377, 36.356]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.JAPANESE], ingredients=[FoodIngredient.FISH], tastes=[], cooking_methods=[FoodCookingMethod.RAW])),
        ...
        ActivityModel(name="반갱", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.385, 36.351]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.KOREAN], ingredients=[FoodIngredient.VEGETABLE], tastes=[], cooking_methods=[])),
        ActivityModel(name="토미야", type=ActivityType.FOOD, category_id=category_ids.get("맛집"), location=GeoJson(coordinates=[127.381, 36.350]), food_attributes=FoodAttributes(cuisine_types=[FoodCuisineType.JAPANESE], ingredients=[FoodIngredient.FLOUR], tastes=[], cooking_methods=[FoodCookingMethod.FRIED])),
    ])
    return activities